...
// Authenticated landing page for contactus.app. Reuses the shared
...
@Component({
  ...
  // so this root-level landing page provides them.
  ...
  template: `
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>Contactus.app</ion-title>
      </ion-toolbar>
    </ion-header>
...
export class ContactusHomePageComponent {}
