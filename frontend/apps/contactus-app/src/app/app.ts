...
// named "menu" outlet (which the space routes mount ContactusSpaceMenuComponent
// into — without this outlet the space route fails to activate and its pages,
// e.g. contacts, never render); elsewhere it shows the spaces list + signed-in
// user.
@Component({
