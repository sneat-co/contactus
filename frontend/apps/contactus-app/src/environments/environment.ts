...
// Single environment for contactus — fail-safe by construction.
...
//
// Reuses the shared sneat production Firebase project (sneat-eur3-1) — contactus
// shares auth, spaces and Firestore with the rest of the sneat ecosystem.
export const contactusAppEnvironmentConfig: IEnvironmentConfig =
  appEnvironmentConfig({
    ...
    firebaseConfig: {
      ...
      // contactus.app, contactus-app.web.app, or a preview channel.
